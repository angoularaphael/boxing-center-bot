...
function buildMail(prenom, nom, email) {
  ...
  const text = [
    ...
    '',
    'Même si tu n’as jamais fait de boxe, tu peux venir essayer. On t’accueille débutant·e, pas besoin d’expérience ni de matériel.',
    '',
    'Une séance dans n’importe lequel de nos clubs à Toulouse — Minimes, Ramonville, Saint-Cyprien, États-Unis ou Portet. Choisis ton créneau ici :',
    '',
    LINK,
    '',
    `Le site : ${SITE_LINK}`,
